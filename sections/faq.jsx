  ...
  const faqs = [
    {
      ...
      a: 'Приложение бесплатное. Внутри платишь только за билеты — по цене организатора, без накруток сервиса. Никакой подписки, нет скрытых платежей.',
      tag: 'цена',
    },
    {
      q: 'Какая комиссия для организатора?',
      a: 'Низкая фиксированная комиссия за каждый проданный билет — без абонентки, без минимального тиража, без пакета документов. Точные ставки — в кабинете организатора, видны до публикации события.',
      tag: 'комиссия',
    },
    {
      q: 'Когда приходят деньги от продажи билетов?',
      a: 'Выплаты в день события. Не через неделю, не «по запросу», не «когда наберётся минимум» — деньги поступают на твою карту сразу после того, как гости пришли.',
      tag: 'выплаты',
    },
    {
      ...
      <div className="wrap" style={{ position: 'relative' }}>
        <div className="shead reveal" style={{ maxWidth: 880 }}>
          ...
          <h2 className="display">
            Что обычно<br />
            <span style={{ color: accent }}>спрашивают первым</span>
          </h2>
          <p>Короткие ответы по делу — деньги, билет, доступ, отмены. Если чего-то нет — напиши в поддержку, добавим.</p>
        </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ overflow: 'hidden' }}>
          <div style={{ padding: '0 24px 22px 70px', color: 'var(--mute)', fontSize: 15.5, lineHeight: 1.55 }}>
            {a}
          </div>
        </div>
      </div>
